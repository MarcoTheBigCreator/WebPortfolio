...
$genInfoQuery = "select * from geninfo";
...
$designSkillsQuery= "select * from designskills";
...
$datafilterQuery= "select * from datafilter";
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1 wow fadeInRight">
                    <h1 class="fw-light">Marco Rodriguez</h1>
                    ...
                    <a href="https://www.canva.com/design/DAFDfZxxbuU/8OkuwCgv3qY9tJDLwSWwzA/view?utm_content=DAFDfZxxbuU&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink" target="blank">
        ...
        <div class="container">
            ...
            <div class="gridder my-3">
                    <?php foreach($portfolio as $row){ ?>
                        <div class="grid-item <?php echo $row['class'];?> wow zoomIn">
            ...
            <div class="row py-5">
                <div class="col-lg-5 pl-5 mr-5 wow fadeInUp">
                    ...
                    <div class="col-lg-5 contactme" style="display: flex;">
                        ...
                        <div>
                            <h3>Email</h3>
                            <span>marco.rodriguez.is@unipolidgo.edu.mx</span>
                        </div>
                    </div>
                </div>
