          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Design Skills<button class="btn btn-success ml-4" id="btnagregar3" onclick="mostrarform3(true)"><i class="fa fa-plus-circle"></i> Agregar</button-->
                </h1>
