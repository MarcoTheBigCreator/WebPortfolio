          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                <h1 class="box-title">Experience<button class="btn btn-success ml-4" id="btnagregar5" onclick="mostrarform5(true)"><i class="fa fa-plus-circle"></i> Agregar</button-->
                </h1>
              ...
              <div class="panel-body" id="formularioregistros5">
